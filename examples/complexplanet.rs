...
fn par_build_noise_map(settings: BuilderSettings) -> NoiseMap {
    ...
    let mtn_base_mod = || -> Box<dyn NoiseFn<_, 3>> {
        ...
        // fjords.
        let terrainTypeDef_tu = Turbulence::new(continentDef.clone())
        ...
        let mountainBaseDef_co = Constant::new(-1.0).wrap_rc();
        ...
        let mountainBaseDef = Cache::new(mountainBaseDef_tu1).wrap_rc();
        ...
        // subgroup.
        let mountainousHigh_ma = Max::new(
            mountainousHigh_rm0,
            mountainousHigh_rm1)
            .wrap_rc();
        ...
        let mountainousHigh = Cache::new(mountainousHigh_tu).wrap_rc();
        ...
        // 5: [Low-flat module]: This low constant value is used by step 6.
        let hillyTerrain_co = Constant::new(-1.0).wrap_rc();
        ...
        // from -1.0 to 1.0.
        let hillyTerrain_ex = Exponent::new(hillyTerrain_sb2)
            .set_exponent(1.375)
            .wrap_rc();
        ...
        // group.
        let hillyTerrain = Cache::new(hillyTerrain_tu1).wrap_rc();
        ...
        let plainsTerrain_mu = Multiply::new(
            plainsTerrain_sb0,
            plainsTerrain_sb1
        ).wrap_rc();
        ...
        // terrain group.
        let plainsTerrain = Cache::new(plainsTerrain_sb2).wrap_rc();
        ...
        let badlandsSand_wo = Worley::new(CURRENT_SEED + 81)
            ...
            .set_return_type(ReturnType::Distance).wrap_rc();
        ...
        let badlandsCliffs_cu = Curve::new(badlandsCliffs_fb)
            ...
            .add_control_point(2.000, 1.250).wrap_rc();
        ...
        // module.
        let badlandsCliffs_cl = Clamp::new(badlandsCliffs_cu)
            .set_bounds(-999.125, 0.875)
            .wrap_rc();
        ...
        let badlandsCliffs_te = Terrace::new(badlandsCliffs_cl)
            ...
            .add_control_point(1.000).wrap_rc();
        ...
        // cliffs module.
        let badlandsCliffs = Cache::new(badlandsCliffs_tu1).wrap_rc();
        ...
        let badlandsTerrain_ma = Max::new(badlandsCliffs, badlandsTerrain_sb).wrap_rc();
        ...
        // group.
        let badlandsTerrain = Cache::new(badlandsTerrain_ma).wrap_rc();
        ...
        let riverPositions_cu0 = Curve::new(riverPositions_rm0)
            ...
            .add_control_point(2.000, -2.000).wrap_rc();
        ...
        let riverPositions_cu1 = Curve::new(riverPositions_rm1)
            ...
            .add_control_point(2.000, 0.0000).wrap_rc();
        ...
        // river-curve module.
        let riverPositions_mi = Min::new(riverPositions_cu0, riverPositions_cu1).wrap_rc();
        ...
        //    positions group.
        let riverPositions = Cache::new(riverPositions_tu).wrap_rc();
        ...
        let scaledMountainousTerrain_ex =
            Exponent::new(scaledMountainousTerrain_fb)
                .set_exponent(1.25)
                .wrap_rc();
        ...
        let scaledMountainousTerrain_mu =
            Multiply::new(scaledMountainousTerrain_sb0, scaledMountainousTerrain_sb1).wrap_rc();
        ...
        let scaledMountainousTerrain = Cache::new(scaledMountainousTerrain_mu).wrap_rc();
        ...
        let scaledHillyTerrain_ex = Exponent::new(scaledHillyTerrain_fb).set_exponent(1.25).wrap_rc();
        ...
        let scaledHillyTerrain_mu = Multiply::new(scaledHillyTerrain_sb0, scaledHillyTerrain_sb1).wrap_rc();
        ...
        let scaledHillyTerrain = Cache::new(scaledHillyTerrain_mu).wrap_rc();
        ...
        let scaledPlainsTerrain = Cache::new(scaledPlainsTerrain_sb0).wrap_rc();
        ...
        let scaledBadlandsTerrain = Cache::new(scaledBadlandsTerrain_sb).wrap_rc();
        ...
        let continentalShelf_cl = Clamp::new(continentalShelf_te).set_bounds(-0.75, SEA_LEVEL).wrap_rc();
        ...
        let continentalShelf_ad = Add::new(continentalShelf_sb, continentalShelf_cl).wrap_rc();

        // 6: [Continental-shelf subgroup]: Caches the output value from the shelf-
        //    and-trenches module.
        let continentalShelf = Cache::new(continentalShelf_ad).wrap_rc();
        ...
        let continentsWithPlains_ad = Add::new(baseContinentElev.clone(), scaledPlainsTerrain).wrap_rc();

        // 2: [Continents-with-plains subgroup]: Caches the output value from the
        // continents-with-plains module.
        let continentsWithPlains = Cache::new(continentsWithPlains_ad).wrap_rc();
        ...
        let continentsWithHills_ad = Add::new(baseContinentElev.clone(), scaledHillyTerrain).wrap_rc();
        ...
        // subgroup.
        let continentsWithMountains_ad0 = Add::new(baseContinentElev.clone(), scaledMountainousTerrain).wrap_rc();
        ...
        let continentsWithMountains_cu = Curve::new(continentDef)
            ...
            .add_control_point(1.0, 0.2500).wrap_rc();
        ...
        let continentsWithMountains_ad1 =
            Add::new(continentsWithMountains_ad0, continentsWithMountains_cu).wrap_rc();
        ...
        // select-high-elevations module.
        let continentsWithMountains = Cache::new(continentsWithMountains_se).wrap_rc();
        ...
        // subgroup.
        let continentsWithBadlands_ad = Add::new(baseContinentElev, scaledBadlandsTerrain).wrap_rc();
        ...
        let continentsWithBadlands_ma = Max::new(continentsWithMountains, continentsWithBadlands_se).wrap_rc();

        // 5: [Continents-with-badlands subgroup]: Caches the output value from the
        //    apply-badlands module.
        let continentsWithBadlands = Cache::new(continentsWithBadlands_ma).wrap_rc();
        ...
        let continentsWithRivers_sb = ScaleBias::new(riverPositions)
            ...
            .set_bias(-RIVER_DEPTH / 2.0).wrap_rc();
        ...
        let continentsWithRivers_ad = Add::new(continentsWithBadlands.clone(), continentsWithRivers_sb).wrap_rc();
        ...
        let continentsWithRivers = Cache::new(continentsWithRivers_se).wrap_rc();
...
//#[allow(non_snake_case)]
// fn world_mod<T, const DIM: usize>() -> Box<impl NoiseFn<T, DIM>> {
//     /// Planet seed. Change this to generate a different planet.
//     const CURRENT_SEED: u32 = 0;
//
//     /// Frequency of the planet's continents. Higher frequency produces
...
//     // 1: [Unscaled-final-planet subgroup]: Caches the output value from the
//     //    continent-with-rivers subgroup.
//     let unscaledFinalPlanet = Cache::new(continentsWithRivers).wrap_rc();
//
