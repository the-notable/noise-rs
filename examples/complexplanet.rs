...
use crate::utils::noise_map_builder_closure::PlaneMapBuilderClosure;
use noise::{utils::*, *};
use noise::utils::noise_map_builder_closure::NoiseMapBuilderClosure;
...
fn main() {
    ...
    let source_func = move |p: [f64; 3]| {
        ...
        unscaledFinalPlanet.get(p)
    };

    let noise_map = PlaneMapBuilderClosure::new(Box::new(source_func))
        .set_size(25, 25)
